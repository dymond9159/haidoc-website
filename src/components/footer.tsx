        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Link href={config.facebookUrl || "#"} className="text-system-11 hover:text-secondary" target="_blank">
                <span className="sr-only">Facebook</span>
                <FacebookIcon className="h-5 w-5" />
              </Link>
              <Link href={config.tiktokUrl || "#"} className="text-system-11 hover:text-secondary" target="_blank">
                <span className="sr-only">TikTok</span>
                <TikTokIcon className="h-5 w-5" />
              </Link>
              <Link href={config.instagramUrl || "#"} className="text-system-11 hover:text-secondary" target="_blank">
            ...
            <div className="mt-4">
              ...
              <Link href={`mailto:${config.supportEmail}`} className="text-secondary">
                {config.supportEmail}
              </Link>
            </div>
          </div>
